...
sub_region: Panama
status: "SOLID — accessible Eastern Pacific outpost with strong marine life, coral under crown-of-thorns pressure"
tier: 3
coral_rating: "Moderate (crown-of-thorns pressure)"
marine_life_rating: Very Good
best_season: Dec-Apr
peak_months: [Jan, Feb, Mar]
access: Santa Catalina via Panama City (6-7 hours by bus)
liveaboard: false
liveaboard_season: ~
water_temp_range: "17-30C"
visibility_range: "8-20m"
experience_level: "Advanced Open Water for Canales; Advanced with Deep specialty and 100+ dives for Contreras"
...
**SOLID — accessible Eastern Pacific outpost with strong marine life, coral under crown-of-thorns pressure.**

Coiba National Park, encompassing Coiba Island and 38 surrounding islands and islets across more than 1,700 km2, became a UNESCO World Heritage Site in 2005. The park's remarkable preservation is an accidental legacy of its history as one of Central America's most notorious penal colonies (1919-2004) — decades of fear kept fishermen, developers, and tourists away, allowing marine ecosystems to thrive largely undisturbed.

In 2021, Panama joined Ecuador, Costa Rica, and Colombia to establish the Eastern Tropical Pacific Marine Corridor (CMAR), a mega marine protected area exceeding 500,000 km2 that links Coiba with Galapagos, Cocos Island, and Malpelo. Coiba is the most accessible of the four from the mainland, though "accessible" is relative — reaching the dive sites still requires commitment.

Coral condition is moderate. Crown-of-thorns starfish have been observed at multiple sites in the Canales area, and their presence appears to be affecting hard coral coverage. Soft corals — particularly sea fans and gorgonians — remain healthy and abundant, especially at the deeper Contreras sites (20-30m). The nutrient-rich cold upwelling that drives the area's marine life productivity also provides some buffer against thermal bleaching, though the same nutrients may favour crown-of-thorns populations.

## Key Dive Sites

The 14 main dive sites are spread across three island groups: Rancheria/Coibita (closest to Santa Catalina), Canales (Afuera and Afuerita islands, 1.5 hours by boat), and Contreras (Uva and Brincanco islands, requiring 2-3 day expeditions with overnight stays in Bahia Honda).

### Contreras Islands (Uva and Brincanco)
...
- **White-tip reef sharks**: The signature encounter — present at virtually every dive site in the park, from shallow resting areas to deeper reef patrols. Approachable with careful bubble management.
- **Nurse sharks**: Colossal individuals at the Contreras sites, among the largest reported in the Eastern Pacific.
- **Whale sharks**: January through March at the Canales sites, particularly Buffet. Sightings are seasonal and not guaranteed — the 2025 season was reportedly poor for whale sharks (an unusual orca pod was spotted instead in February).
- **Hammerhead sharks**: June-July at the Contreras Islands. Requires rainy season expedition.
- **Humpback whales**: September through November, arriving to calve in the warm waters of the Gulf of Chiriqui.
- **Turtles**: Loggerhead turtles common across all sites. Hawksbill and leatherback turtles also present.
- **Rays**: Longtail stingrays, Halle's round stingrays, spotted eagle rays, mobula rays.
- **Dolphins**: Pantropical spotted dolphins and bottlenose dolphins regularly seen on boat transits.
- **Tropical fish**: King angelfish and Cortez angelfish are abundant. Also: razor surgeonfish, black-nosed butterflyfish, longfin bannerfish, Cortez rainbow wrasse, Pacific spadefish, jackfish, bluefin trevally, stone triggerfish, trumpetfish, frogfish.
- **Macro**: Harlequin shrimp (rare but present at Iglesia), Pacific seahorses, tufted tube blennies, snowflake moray eels, varied starfish.

## Dive Conditions

- **Temperature**: Dramatic thermoclines define diving here. Surface 28-30C but cold nutrient-rich upwelling can drop temperatures to 17C at depth (36m). Thermoclines can be as shallow as 5m when currents shift cold water masses. The temperature swing of 10C+ in seconds is disorienting and genuinely cold.
- **Exposure protection**: Dive centres only stock 3mm rental wetsuits — wholly inadequate for deeper sites. Bring your own 5mm minimum, 7mm recommended for Contreras dives. Same guidance as [Galapagos](galapagos.md).
- **Visibility**: Variable. 8-20m typical. Cold upwelling water is murky with plankton (this is what drives the marine life). Thermocline layers can create sudden transitions from clear to near-zero visibility. Best during dry season (December-April).
- **Currents**: Moderate to strong, especially at Contreras sites. Negative entries (backroll without BCD inflation) required at Contreras. Drift dives common at Canales.
- **Experience level**: Canales islands are manageable for confident Advanced Open Water divers. Contreras demands Advanced certification with Deep specialty and approximately 100 logged dives. Open Water divers with 10-30 dives can handle some Canales sites but will miss the best the park offers.
- **DIN regulators**: Dive centres in Santa Catalina only have yoke tanks — bring your DIN adapter if needed.

## Season

| Period | Conditions | Highlights |
|---|---|---|
| **Dec-Apr (dry season)** | Best visibility, calm seas, surface 28-30C (cold at depth) | Whale sharks Jan-Mar at Canales; best overall diving window |
| **Jun-Jul (early rainy)** | Reduced visibility, more rain | Hammerhead sharks at Contreras Islands |
| **Sep-Nov (late rainy)** | Heavy rainfall (20+ rain days/month), rougher seas | Humpback whale calving season |

The dry season (December-April) is the recommended window. The rainy season brings heavy daily rainfall and reduced underwater visibility, though specific encounters (hammerheads, humpback whales) draw experienced divers in the off-season.
...
- [Galapagos](galapagos.md) — CMAR corridor partner; comparable thermoclines and pelagic focus but vastly larger megafauna encounters
- [Cocos Island](cocos-island.md) — CMAR corridor partner; hammerhead and whale shark connectivity
- [Malpelo](malpelo.md) — CMAR corridor partner; similar remote Eastern Pacific diving
- [Hammerhead Triangle](hammerhead-triangle.md) — the corridor connecting Galapagos, Cocos, and Malpelo (Coiba is the accessible gateway to this region)
