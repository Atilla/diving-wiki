...
status: "Offshore location provides resilience"
tier: 1
...
water_temp_range: "16-29C"
visibility_range: "10-30m"
experience_level: "Advanced (50-100 logged dives minimum; 200+ recommended)"
...
- Mainland Costa Rica reefs devastated (90%+ loss at some Pocillopora sites). Cocos, 342 miles offshore in cooler water, shows "high recovery after bleaching events."
- Primarily a hammerhead/pelagic destination. Schools of hundreds of hammerheads, whale sharks, mantas.
- **Top 5 world diving destination.**
...
- **Bottlenose dolphins**: Frequently encountered on transits.
- **Red-lipped batfish**: Endemic oddity on sandy bottoms — a macro bonus between pelagic dives.

## Dive Conditions

- **Visibility**: 10–30m, with 15–20m typical. Variable by site and season.
- **Temperature**: Surface 27–29C, but dramatic thermoclines — deep water at Alcyone can drop to 16–20C in seconds. 5–7mm wetsuits standard.
- **Currents**: Moderate to very strong, can shift direction unpredictably. Downwellings at seamount sites. Reef hooks and SMBs essential.
- **Experience level**: Genuinely advanced diving — strong currents, blue-water descents, limited surface support. Most operators require Advanced OW + 50–100 logged dives; 200+ with current experience strongly recommended in practice.
- **Dive profiles**: Multi-level to 25–35m, 2–4 dives per day. Nitrox standard on all liveaboards.
...
- **UNESCO World Heritage Site** since 1997. National park — all extractive activities prohibited. Landing restricted to Chatham and Wafer bays with ranger permission.
