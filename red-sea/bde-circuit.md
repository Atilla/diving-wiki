---
destination: Brothers, Daedalus, Elphinstone (BDE Circuit)
region: Red Sea
sub_region: Central/Offshore
status: "Mixed — recovering, Elphinstone a positive surprise"
tier: 3
coral_rating: "Poor-Moderate"
marine_life_rating: "Excellent sharks"
best_season: "October-November"
peak_months: [Oct, Nov]
access: "Hurghada/Port Ghalib"
liveaboard: true
liveaboard_season: "Oct-May"
water_temp_range: "21-28C"
visibility_range: "20-40m"
experience_level: "Advanced (minimum 50+ dives)"
...
Smaller reef, walls on all sides from 5m to 60m+. East and south walls are the primary shark aggregation zone — oceanic whitetips cruise at 15–30m. Dense soft coral on the north wall. Arguably the single best site in the Red Sea for shark encounters.
...
- **Oceanic whitetip sharks**: The circuit's headline species. Most reliable at Little Brother (year-round) and Elphinstone North Plateau (Oct–Dec). Population appears to have declined from early 2010s peak — encounters of 3–5 individuals now typical versus previous 10+. Still the world's most dependable destination for this species.
- **Hammerheads**: Schooling scalloped hammerheads at Daedalus and Big Brother, primarily Nov–Feb. ~50–70% hit rate during peak season.
- **Grey reef sharks**: Common at all four sites; often 5–15 along walls and plateaus.
- **Thresher sharks**: Rare but recorded. Not reliable.
- **Mantas**: Occasional at Daedalus and Elphinstone, more likely Aug–Oct.
- **Other**: Bottlenose dolphins (frequent), green and hawksbill turtles, giant trevally, schooling barracuda, Napoleon wrasse.

## Dive Conditions

- **Visibility**: 20–40m; can exceed 40m at Daedalus. Occasionally 15m during plankton blooms.
- **Temperature**: 24–28C summer, 21–24C winter. 5mm or semidry recommended Oct–Apr.
- **Currents**: Can be very strong — 2+ knots at exposed plateaus. Down-currents at wall edges, particularly Big Brother and Daedalus.
- **Surface conditions**: All exposed open-ocean reefs with no shelter. 1–2m swells routine; trips cancelled in rough weather (more common Dec–Feb). Zodiac pickups in chop require experience.
...
- **Oct–Nov**: Peak — warmest water (26–28C), best visibility, oceanic whitetips most active, hammerheads beginning, calmest seas.
