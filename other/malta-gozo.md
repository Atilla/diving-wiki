---
destination: Malta & Gozo
region: Other
sub_region: Europe / Mediterranean
status: "Good — the Mediterranean's premier wreck diving destination; world-class geological sites at Gozo"
tier: 3
coral_rating: "N/A (Mediterranean)"
marine_life_rating: "Good (Med-grade)"
best_season: "May-November (best September-October)"
peak_months: [Sep, Oct]
access: "Fly MLA (low-cost from Europe)"
liveaboard: false
liveaboard_season: ~
water_temp_range: "14-28C"
visibility_range: "30-40m"
experience_level: "Open Water (many sites) to Technical (deep wrecks, caves)"
...
- **Groupers**: Dusky groupers (*Epinephelus marginatus*) relatively common, particularly around Gozo.
- **Barracuda**: Schools of Mediterranean barracuda around wrecks and reef walls.
- **Amberjack**: Common around wrecks, especially Um El Faroud.
- **Octopus**: Common octopus frequently sighted — macro photographer favorite.
...
- **Visibility**: 30–40m typical; 40–50m on good summer/autumn days. One of the Med's clearest waters.
- **Temperature**: 14–16C winter (drysuit territory), 16–20C spring, 23–28C summer, 20–25C autumn. September–October warmest water (thermal lag). Thermoclines at 15–25m in summer (3–5C drop).
- **Currents**: Generally mild. Comino Channel can have significant current (relevant for Cirkewwa dives). South coast can have surge.
- **Experience level**: Many sites suit Open Water (P-31, HMS Maori, shallow reef). Advanced OW opens most wreck tops. Deep/wreck penetration and cave sites require technical certification.

## Technical Diving

Malta is one of Europe's premier tech diving destinations:

- **Trimix and heliox fills** readily available from multiple operators — unusual for the Med.
- **Rebreather support**: O2, diluent, scrubber material. Inspiration, JJ-CCR, rEvo, AP Diving all supported.
- **Deep wreck targets**: HMS Stubborn (~56m), Schnellboot/E-boat (~65–70m), Le Polynesien (WWI French troop transport, ~70m+), HMS Russell (pre-dreadnought battleship, ~115m+ — extreme tech).
- **Cave systems**: Billinghurst Cave (Gozo), Ghar Lapsi system (Malta).
- **DPV/scooter rentals** at some operators. GUE, TDI, IANTD, PADI TecRec courses all available.

## Season

- **Peak**: September–October — warmest water (24–27C), best visibility (30–40m+), stable weather, fewer crowds than August.
- **Main season**: May–November. Summer (Jul–Aug) excellent diving but crowded topside and hot (35C+).
- **Winter**: Diveable year-round (many operators run 12 months) but 14–16C water and rougher seas limit site access. Visibility can be excellent after storms settle.
