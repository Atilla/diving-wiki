...
best_season: Nov-Apr (whale sharks Mar-Jun)
peak_months: [Nov, Dec, Jan, Feb, Mar, Apr]
access: Fly Belize City
liveaboard: true
liveaboard_season: Year-round
water_temp_range: "26-29C"
visibility_range: "18-30m"
experience_level: Open Water minimum, Advanced OW recommended
...
### Lighthouse Reef Atoll — the standout
...
- Contains ~800 coral patch reefs across 135 square miles. The most remote of the three atolls.
- UNESCO World Heritage Site with Wildlife Conservation Society research station.
- Still regarded as a top destination with thriving coral formations, though limited 2024-2025 survey data.

## Marine Life
- **Reef sharks**: Caribbean reef sharks encountered on almost every dive at Lighthouse Reef. Nurse sharks common under overhangs at all three atolls.
- **Eagle rays**: Reliable at Turneffe and Lighthouse Reef.
- **Turtles**: Hawksbill and green turtles at multiple sites. Half Moon Caye is a nesting site for loggerheads.
- **Whale sharks**: Seasonal at Gladden Spit, coinciding with snapper spawning around the full moon (Mar–Jun, peak Apr–May). Not guaranteed but reliability highest during full-moon windows.
- **Large groupers**: Nassau grouper aggregations historically significant; populations rebuilding under moratorium.
- **Parrotfish**: Populations rebounding significantly following moratorium and enforcement.
- **White-spotted toadfish**: Endemic to Turneffe Atoll.
...
- **Wall dives and deeper reefs are in notably better condition than shallow reef flats.** By Caribbean standards, Belize — particularly Lighthouse Reef — is one of the better options. Multiple experienced divers noted it compares favorably to Bermuda, Puerto Rico, and parts of Mexico.

## Dive Conditions
- **Visibility**: 18–30m on the atolls; clearest Mar–Jun when runoff is minimal.
- **Temperature**: 26–29C year-round (warmest Jul–Oct, coolest Jan–Mar). 3mm sufficient; some prefer 5mm Dec–Feb.
- **Currents**: Mild to moderate inside atolls and along sheltered walls. Notably stronger on seaward (eastern) walls, particularly Turneffe's outer edge and the Elbow at Lighthouse Reef.
- **Profiles**: Most dives are wall or drift in the 15–30m range; deeper excursions to 40m at the Blue Hole and outer drop-offs.

## Season
- **Dry season (Nov–Apr)**: Calmest seas, best topside weather.
- **Wet season (Jun–Nov)**: Afternoon squalls, warmer water, fewer crowds. Hurricane season peaks Aug–Oct — most operators avoid late Sep/Oct or offer flex-booking.
- **Whale sharks at Gladden Spit**: Coincides with snapper spawning around the full moon, **Mar–Jun** (peak Apr–May). Operators schedule dedicated Gladden Spit itineraries around these dates. Not guaranteed but reliability highest during full-moon windows.
